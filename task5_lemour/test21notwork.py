...
class SnowTracker:
    def __init__(self, root, rows, cols):
        ...
        self.canvas.bind("<Button-1>", self.decrease_snow)
        self.canvas.bind("<Button-3>", self.increase_snow)
    ...
    def draw_grid(self):
        ...
        for row in range(self.rows):
            for col in range(self.cols):
                ...
                color = SNOW_COLOR if self.grid[row][col] >= 2 else DEFAULT_COLOR
